					...
					<div class="col-md-12">
						...
						<div class="box box-info">
							...
							<?php foreach ($pengeluaranbiayaoprasional_edit as $dataedit) { ?>
								<form action="<?php echo base_url(). 'superadmin/pengeluaranbiayaoprasional_updateaksi'; ?>"
									...
									<div class="box-body">
										...
										<div class="form-group">
											...
											<div class="col-sm-10">
												<input type="text" name="" value="<?php echo $dataedit->nama_pengeluaran;?>" class="form-control" readonly>
											</div>
										</div>
										<?php
										...
										<div class="form-group">
											...
											<div class="col-sm-10">
												<input type="number" name="saldo_kas"  value="<?php echo $saldo_akhir_kas;?>" class="form-control" readonly>
											</div>
										</div>
										<div class="form-group">
											<label class="col-sm-2 control-label">Nominal</label>
											<div class="col-sm-10">
												<input type="number" name="nominal" value="<?php echo $dataedit->nominal;?>" class="form-control" >
											</div>
										</div>
										<div class="form-group">
											<label class="col-sm-2 control-label">Masa Pemakaian</label>
											<div class="col-sm-10">
												<input type="text" name="masa_sewa" value="<?php echo $dataedit->masa_sewa;?>" class="form-control" >
											</div>
										</div>
									</div>
