  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="col-md-12">
       ...
       <a href="<?php echo base_url('C_modul_admin_resto/lihat_bahan_mentah?');?>id_permintaan=<?php echo $_GET['id_permintaan']; ?>" class="btn btn-primary btn"><i class="fa   fa-check" ></i> KEMBALI TAMBAH PERMINTAAN BAHAN OLAHAN</a><br>
       <br>
     </div>
     ...
     <?php
      ...
      <div class="col-md-4">
            ...
            <div class="box box-info">
              ...
              <!-- /.box-header -->
              <!-- form start -->
              <form action="<?php echo base_url(). 'C_modul_admin_resto/aksi_kembalikan_bahan_mentah'; ?>" method="post" class="form-horizontal">
                <div class="box-body">
