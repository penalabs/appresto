  ...
  <div class="content-wrapper">
	...
	<div class="row">
				...
				<div class="box box-primary">
					...
					<!-- /.box-header -->
					<!-- form start -->
					<form  action="<?php echo base_url(). 'general_manager/action_add_gaji'; ?>" method="post" role="form">
					  <div class="box-body">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="exampleInputPassword1" name="nominal_gaji" placeholder="Nominal gaji">
            </div>
