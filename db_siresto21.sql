...
MySQL - 5.5.5-10.1.31-MariaDB : Database - db_siresto
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`db_siresto` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
/*Table structure for table `detail_kas_cabang` */

DROP TABLE IF EXISTS `detail_kas_cabang`;

CREATE TABLE `detail_kas_cabang` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `id_kas` varchar(255) DEFAULT NULL,
  `id_cabang` varchar(255) DEFAULT NULL,
  `tgl` date DEFAULT NULL,
  `id_owner` int(255) DEFAULT NULL,
  `id_bendahara` int(255) DEFAULT NULL,
  `jumlah_kas` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;

/*Data for the table `detail_kas_cabang` */

insert  into `detail_kas_cabang`(`id`,`id_kas`,`id_cabang`,`tgl`,`id_owner`,`id_bendahara`,`jumlah_kas`) values (1,'1','1','2020-03-11',1,1,'500000'),(2,'1','1','2020-03-11',2,1,'500000');
...
insert  into `detail_pembelian_alat`(`id`,`id_transaksi`,`id_alat`,`jumlah`,`harga_beli`) values (12,'1','1','1','8000'),(13,'6','1','7','7000'),(14,'7','1','1','9000'),(15,'7','1','30','5000'),(16,'7','1','10','5000'),(17,'1','1','10','10000'),(18,'1','1','10','10000');
...
insert  into `investasi_cabang`(`id`,`id_kas`,`nama_investasi`,`tanggal_mulai`,`tanggal_selesai`,`jumlah_pengeluaran`,`persen_penyusutan`,`status`) values (4,2,'Dekorasi','2019-10-01','2019-10-31',20000,10,'disetujui'),(5,2,'Renovasi','2019-10-01','2019-10-30',5000,20,'invest dikembalikan'),(6,2,'Pembelian p','2019-10-01','2019-10-30',500000,20,'invest dikembalikan'),(7,2,'Pengecetan','2019-10-01','2019-10-30',80000,20,'permintaan'),(8,2,'pembelian alat','2019-10-01','2019-10-30',700000,10,'permintaan'),(9,2,'sewa ruko','2020-01-14','2025-01-14',200000000,10,'permintaan'),(10,2,'renovasi','2020-02-01','2020-05-01',50000000,10,'permintaan');
...
insert  into `investasi_owner`(`id`,`id_super_admin`,`id_owner`,`id_bendahara`,`tanggal`,`jumlah_investasi`,`jangka_waktu`,`persentase_omset`) values (1,1,1,2,'2019-11-30',90000,'2 bulan',20),(2,1,1,2,'2019-11-30',9000,'3 bulan',20),(3,1,1,32,'2020-03-07',500000,'2 bulan',20);
...
insert  into `kas`(`id`,`nama_akun`) values (1,'KAS BESAR'),(2,'KAS KECIL');

/*Table structure for table `kas_cabang` */
...
/*Data for the table `kas_cabang` */

insert  into `kas_cabang`(`id`,`id_kas`,`saldo`) values (1,'1','1000000'),(2,'1','500000');
...
insert  into `pembayaran`(`id`,`id_user_kasir`,`id_pemesanan`,`nominal`,`status`,`tanggal`) values (34,23,2,15000,'lunas','2020-01-30 21:35:25'),(35,23,1,25000,'lunas','2020-01-30 15:42:30'),(36,23,3,20000,'lunas','2020-02-02 17:09:06'),(38,23,4,25000,'lunas','2020-02-02 20:42:38'),(39,22,5,15000,'lunas','2020-02-01 16:55:53');
...
insert  into `pemesanan`(`id`,`nama_pemesan`,`no_meja`,`keterangantambahan`,`tanggal`,`total_harga`,`id_user_resto`,`status`) values (1,'coba1',1,'','2020-01-30 21:35:00',24000,23,'lunas'),(2,'coba2',2,'','2020-01-30 21:35:25',13000,23,'lunas'),(3,'coba3',3,'ini pembayaran dilakukan di kasir','2020-02-02 21:49:42',16000,23,'lunas'),(4,'coba4',4,'','2020-02-01 21:58:05',13000,23,'lunas'),(5,'coba5',5,'','2020-02-01 22:53:18',13000,23,'lunas'),(6,'coba5',1,'','2020-02-01 22:53:42',0,23,'siapsaji');
...
insert  into `peralatan`(`id`,`id_logistik`,`id_resto`,`nama_peralatan`,`satuan_besar`,`jumlah_stok`,`status`) values (1,3,1,'sendok','pcs',60,1);
