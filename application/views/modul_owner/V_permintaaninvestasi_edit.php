  ...
  <div class="row">
    <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <form action="<?php echo base_url(). 'modul_general_manager/permintaaninvestasi_editaksi'; ?>" method="post" class="form-horizontal">
              <div class="box-body">
                <?php
                ...
                $data2=$this->db->query($sql1)->result();
                 ...
                 <div class="form-group">
                          ...
                          <div class="col-sm-10">
                            <input type="text" class="form-control pull-right" value="<?php echo $investasi_kanwil->tanggal;?>" name="tanggal" id="datepicker">
                          </div>
                 </div>
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Nominal Investasi</label>
                  <div class="col-sm-10">
                    <input type="number" name="nominal_investasi" value="<?php echo $investasi_kanwil->nominal_investasi;?>" class="form-control" >
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Penyusutan</label>
                  <div class="col-sm-10">
                    <input type="number" name="penyusutan" value="<?php echo $investasi_kanwil->penyusutan;?>" class="form-control" >
                  </div>
                </div>
