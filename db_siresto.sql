...
-- Records of menu
-- ----------------------------
INSERT INTO `menu` VALUES (1, 1, 'Ayam Geprek', 'nasibebek.jpg', 10000, 'tersedia', 10, 'insert');
INSERT INTO `menu` VALUES (2, 1, 'Jamur Kripsi', '124789-mint-background-2560x1600-for-ios.jpg', 10000, 'tersedia', 10, 'insert');
INSERT INTO `menu` VALUES (3, 1, 'Es Teh Anget', '124789-mint-background-2560x1600-for-ios4.jpg', 10000, 'tersedia', 10, 'insert');
INSERT INTO `menu` VALUES (4, 1, 'Kopi Susu', '', 3000, 'tersedia', 6, 'insert');
INSERT INTO `menu` VALUES (5, 1, 'Nasi Goreng', '', 6000, 'habis', 5, 'insert');
...
CREATE TABLE `operasional`  (
  ...
  `lama_sewa` varchar(11) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `harga_sewa` varchar(11) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = Compact;
...
-- ----------------------------
INSERT INTO `operasional` VALUES (1, 'listrik', '1 bulan', '50000');
INSERT INTO `operasional` VALUES (2, 'kodomo', '12', '4');
...
-- Records of paket
-- ----------------------------
INSERT INTO `paket` VALUES (1, 1, 'Paket Bom', 1, 'tersedia', 'gepreksai3.jpg', '8000', 'insert');
INSERT INTO `paket` VALUES (2, 1, 'Paket Granat', -1, 'tersedia', '', '20000', 'insert');
...
CREATE TABLE `pembelian_alat`  (
  ...
  `jumlah` int(11) NOT NULL,
  `tanggal` date NOT NULL,
  `harga_beli` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
-- ----------------------------
INSERT INTO `pembelian_alat` VALUES (1, 1, 10, '2019-10-10', '10000', '100000');
...
-- ----------------------------
INSERT INTO `pembelian_bahan_mentah` VALUES (1, 1, 10, '2019-10-10', '10000', '100000');
...
INSERT INTO `pemesanan` VALUES (3, 'wahyu', 6, 'gelas besar', '2019-09-29 11:10:37', 3000, 2, 'produksi');
...
-- ----------------------------
INSERT INTO `pengeluaran_cabang_operasional` VALUES (1, 1, 1, '2019-08-22', 1, '5000');
INSERT INTO `pengeluaran_cabang_operasional` VALUES (2, 1, 1, '2019-08-22', 1, '90');
...
-- ----------------------------
INSERT INTO `pengeluaran_kanwil_operasional` VALUES (1, 1, 1, '2019-08-22', '5000');
INSERT INTO `pengeluaran_kanwil_operasional` VALUES (2, 1, 1, '2019-08-22', '90');
INSERT INTO `pengeluaran_kanwil_operasional` VALUES (3, 1, 1, '2019-08-22', '100');
INSERT INTO `pengeluaran_kanwil_operasional` VALUES (4, 1, 1, '2019-08-22', '2000');
...
-- ----------------------------
INSERT INTO `peralatan` VALUES (1, 1, 'sendok', 10, 0);
...
-- ----------------------------
-- Table structure for tbl_pengeluaran_kebutuhan
-- ----------------------------
...
CREATE TABLE `tbl_pengeluaran_kebutuhan`  (
  ...
  `nominal_pengeluaran_kebutuhan` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id_pengeluaran_kebutuhan`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Records of tbl_pengeluaran_kebutuhan
-- ----------------------------
INSERT INTO `tbl_pengeluaran_kebutuhan` VALUES (2, 'Bahan Bakar Masak', 100000);
INSERT INTO `tbl_pengeluaran_kebutuhan` VALUES (3, 'Transportasi', 200000);
