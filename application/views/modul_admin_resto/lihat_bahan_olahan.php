  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="col-md-12">
       ...
       <a href="<?php echo base_url('C_modul_admin_resto/lihat_bahan_olahan?');?>id_permintaan=<?php echo $_GET['id_permintaan']; ?>" class="btn btn-primary btn"><i class="fa   fa-check" ></i> KEMBALI TAMBAH PERMINTAAN BAHAN OLAHAN</a><br>
       <br>
     </div>
     ...
     <?php
      ...
      <div class="col-md-4">
            ...
            <div class="box box-info">
              ...
              <!-- /.box-header -->
              <!-- form start -->
              <form action="<?php echo base_url(). 'C_modul_admin_resto/aksi_kembalikan_bahan_olahan'; ?>" method="post" class="form-horizontal">
                <div class="box-body">
      ...
      <div class="col-md-4">
            ...
            <div class="box box-info">
              <div class="box-header with-border">
                <h3 class="box-title">Tambah list Bahan Olahan<i class="fa  fa-hand-lizard-o" ></i></h3>
              </div>
              <!-- /.box-header -->
              <!-- form start -->
              <form action="<?php echo base_url(). 'C_modul_admin_resto/aksi_tambah_list_bahan_olahan'; ?>" method="post" class="form-horizontal">
                <div class="box-body">
                  <input type="hidden" name="id_permintaan" value="<?php echo $_GET['id_permintaan'];?>" class="form-control" id="inputEmail3" >
                  <!-- <input type="text" name="id_bahan_olahan" value="<?php echo $_GET['id_bahan_olahan'];?>" class="form-control" id="inputEmail3" > -->
                  <div class="form-group">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td><?=$u->status;?></td>
                        <td>
                          <a href="<?php echo base_url('C_modul_admin_resto/lihat_bahan_olahan/?');?>id_bahan_olahan=<?php echo $u->id_bahan_olahan ?>&&edit=edit&&id_permintaan=<?=$_GET['id_permintaan'];?>&&id=<?php echo $u->id; ?>&&jumlah_dikirim=<?php echo $u->jumlah_dikirim; ?>&&jumlah_permintaan=<?php echo $u->jumlah_permintaan; ?>" class="btn btn-primary btn-xs"><i class="fa   fa-edit" ></i>Return</a><br>
                          <a href="<?php echo base_url('C_modul_admin_resto/hapus_list_bahan_olahan/?');?>id=<?php echo $u->id ?>&&id_permintaan=<?=$_GET['id_permintaan'];?>" class="btn btn-danger btn-xs"><i class="fa   fa-close" ></i>Hapus</a>
                          <?php
                          if($u->status!="diterima"){
                           ?>
                          <a href="<?php echo base_url('C_modul_admin_resto/terima_list_bahan_olahan/?');?>id=<?php echo $u->id ?>&&id_permintaan=<?=$_GET['id_permintaan'];?>&&id_bahan_olahan=<?=$u->id_bahan_olahan;?>&&jumlah_bahan_diterima=<?=$u->jumlah_dikirim;?>" class="btn btn-success btn-xs"><i class="fa   fa-close" ></i>Terima</a>
                          <?php
                            }
                           ?>
                        </td>
...
<script type="text/javascript">
  ...
  function SelectDataPemesananMenu(){
    $.ajax({
      type:'POST',
      url:'<?php echo base_url().'C_modul_admin_resto/data_pemesanan_menu' ?>',
      dataType:'json',
  ...
  function SelectDataPemesananPaket(){
    $.ajax({
      type:'POST',
      url:'<?php echo base_url().'C_modul_admin_resto/data_pemesanan_paket' ?>',
      dataType:'json',
      success: function(data){
        var no = 0;
        var baris = '';
  ...
  function get_stok_bahan_mentah(id_bahan_mentah)[
    $.ajax({
              type  : 'POST',
              url   : '<?php echo base_url(). 'C_modul_admin_resto/get_stok_bahan_mentah'; ?>',
