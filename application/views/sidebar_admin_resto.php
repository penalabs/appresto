 <!-- Left side column. contains the sidebar -->
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <li><a href="<?php echo base_url('C_modul_admin_resto/anggaranbiayaoprasional_view');?>"><i class="fa fa-circle-o"></i> Anggaran Biaya Operasional</a></li>
      ...
      <li><a href="<?php echo base_url('C_modul_admin_resto/pengeluaranbiayaoprasional_view');?>"><i class="fa fa-circle-o"></i> Pengeluaran Biaya Operasional </a></li>
