          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form class="form-horizontal" action="<?php echo base_url(). 'modul_resto/tambah_data_permintaan_bahan'; ?>" method="post" role="form">
                  <div class="box-body">
                    <div class="box-body">
        ...
        <div class="modal fade" id="myModalEdit" role="dialog">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form class="form-horizontal" action="<?php echo base_url(). 'modul_resto/update_data_permintaan_bahan'; ?>" method="post" role="form">
                  <div class="box-body">
                    <div class="box-body">
                      <div class="form-group">
                        <label for="inputPassword3" class="col-sm-2 control-label">permintaan</label>
...
<script type="text/javascript">
  ...
  function SelectDataPermintaanBahan(){
    $.ajax({
      type:'POST',
      url:'<?php echo base_url().'modul_resto/data_permintaan_bahan' ?>',
      dataType:'json',
          ...
          baris +=
                '<tr>'+
                    ...
                    '<td> '+'<a '+button_edit+'              href="#myModalEdit" onclick="edit('+data[i].id_permintaan+')" class="btn btn-success btn-xs" data-toggle="modal" > <i class="fa  fa-edit" ></i></a>'+
                            '<a '+button_delete+'            href="<?php echo site_url('modul_resto/delete_data_permintaan_bahan/') ?>'+data[i].id_permintaan+' " class="btn btn-danger btn-xs" data-toggle="modal" > <i class="fa  fa-trash" ></i></a>'+
                            '<a '+button_detail+'            href="<?php echo site_url('modul_resto/data_permintaan_bahan_detail/') ?>'+data[i].id_permintaan+' " class="btn btn-info btn-xs" data-toggle="modal" > Detail </a>'+
                    '</td>'
                +'<tr>';
        }
        $('#target').html(baris)
...
<script type="text/javascript">
  function edit(id_permintaan){
    $.ajax({
      type:'POST',
      url:'<?php echo base_url().'modul_resto/edit_data_permintaan_bahan/' ?>'+id_permintaan,
      dataType:'json',
      success: function(data){
  ...
  function updatedata(){
    ...
    $.ajax({
      ...
      url:'<?php echo base_url().'modul_resto/update_data_permintaan_bahan' ?>',
      dataType:'json',
      success: function(data){
