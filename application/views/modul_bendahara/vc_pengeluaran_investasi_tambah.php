  ...
  <div class="row">
    <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form action="<?php echo base_url(). 'modul_bendahara/bendahara_pengeluaran_investasi_tambahaksi'; ?>" method="post" class="form-horizontal">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                      ...
                      $data_kas=$this->db->query($sql)->row();
        						  ...
        						  $sql4 = "SELECT sum(nominal_investasi) as nominal_investasi_kanwil FROM investasi_kanwil where id_kanwil='$id_kanwil'";
