                            ...
                            <div class="card-body">
                                ...
                                <div class="basic-form">
                                    <form id="myform">
                                        ...
                                        <button type="button" onclick="simpan_pesan();" class="btn btn-dark">PESAN</button>
                                    </form>
                                </div>
                            </div>
                        </div>
                        ...
                        // alert(value.id_menu);
                          $('#myTable > tbody').append('<tr>'+
                              ...
                              '<td>'+
                                ...
                                '<input type="text" id="jumlah_menu" style="width:40px;height:40px;float:left;" class="form-control input-default" value="'+value.jumlah+'">'+
                        ...
                        // alert(value.id_paket);
                          $('#myTable2 > tbody').append('<tr>'+
                              ...
                              '<td>'+
                                ...
                                '<input type="text" id="jumlah_paket" style="width:40px;height:40px;float:left;" class="form-control input-default" value="'+value.jumlah+'">'+
