    ...
    <div class="alert alert-danger alert-dismissible">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Tambah masakan ke MENU <i class="fa  fa-hand-lizard-o" ></i></h3>
			  <?php echo $id_last_menu->id+1;?>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url(). 'modul_resto/action_add_item_menu'; ?>" method="post" role="form">
              <div class="box-body">
                ...
                ?>
                      <tr>
                        ...
                        <td><?=$u3->nama_masakan;?></td>
                         <td><?=$u3->jumlah;?></td>
      				          <td>Rp. <?=$u3->harga;?></td>
                        <td><a href="<?php echo base_url(). 'modul_resto/hapus_item_menu'; ?>/?id=<?=$u3->id;?>&&tb=daftar_masakan&&id_bahan_jadi=<?=$u3->id_bahan_jadi;?>&&jumlah=<?=$u3->jumlah;?>&&id_menu=<?php echo $id_last_menu->id+1;?>" class="btn btn-danger btn-xs"><i class="fa  fa-close" ></i></a></td>
                      </tr>
                      <?php 
