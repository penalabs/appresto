    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="kategori_menu_sub1.php">Paket</a></li>
		...
		<section class="wrapper">
					<?php
					$querykategori = "SELECT * FROM tbl_kategori_paket WHERE parent_id = '0'";
					$hasilkategori = mysqli_query($koneksi,$querykategori);
					while($datakategori=mysqli_fetch_array($hasilkategori)){?>
						<a href="kategori_paket_sub2.php?idkategorimenu2=<?php echo $datakategori['id_kategori'];?>">
