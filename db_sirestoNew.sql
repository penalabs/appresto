...
MySQL - 10.3.16-MariaDB : Database - db_siresto
*********************************************************************
*/
...
(5,4,23,'2020-01-01','2020-01-31','bulanan',2005000),
...
(26,0,32,'Renovasi Taman','0000-00-00','0000-00-00',1000000,1,'permintaan');
...
(1,1,2,2,'2019-11-30',90000,'2 bulan',20),
(2,1,2,2,'2019-11-30',9000,'3 bulan',20),
(6,1,1,32,'2020-03-08',10000000,'12 bulan',1),
(7,1,1,32,'2020-03-25',10000000,'24 bulan',1),
(8,1,1,32,'2020-03-27',20000000,'48 bulan',1),
(9,1,1,32,'2020-04-01',10000000,'12 bulan',1),
(10,1,1,32,'2020-04-03',1000000,'12 bulan',1),
(11,1,1,32,'2020-04-03',10000,'6 bulan',1),
(12,1,1,32,'2020-04-01',9000000,'12 bulan',1),
(13,1,1,32,'2020-04-01',1000000,'12 bulan',1);
...
/*!50003 CREATE */ /*!50017 DEFINER = 'root'@'localhost' */ /*!50003 TRIGGER `detail_kas_mutasiCabang` AFTER INSERT ON `investasi_cabang` FOR EACH ROW 
    BEGIN
...
/* Trigger structure for table `investasi_owner` */

DELIMITER $$

/*!50003 DROP TRIGGER*//*!50032 IF EXISTS */ /*!50003 `detail_kas_investor` */$$

/*!50003 CREATE */ /*!50017 DEFINER = 'root'@'localhost' */ /*!50003 TRIGGER `detail_kas_investor` AFTER INSERT ON `investasi_owner` FOR EACH ROW BEGIN
	INSERT INTO `detail_kas`
	SET id_ref_kas = NEW.id,
	jenis_kas="kas induk",
	tipe_kas="Masuk",
	tanggal=new.tanggal,
	id_superadmin="1",
	id_user=new.id_bendahara,
	nominal = new.jumlah_investasi,
	tipe_user="Investasi Owner";
    END */$$
...
/*!50003 CREATE */ /*!50017 DEFINER = 'root'@'localhost' */ /*!50003 TRIGGER `detail_kas_alat` AFTER INSERT ON `pembelian_alat` FOR EACH ROW 
BEGIN
    INSERT INTO `detail_kas`
    set id_ref_kas = NEW.id,
    jenis_kas="kas induk",
