    ...
    <section class="content">
      ...
      <div class="col-md-4">
            ...
            <div class="box box-info">
              ...
              <!-- /.box-header -->
              <!-- form start -->
              <form action="<?php echo base_url(). 'modul_produksi/aksi_tambah_bahan_mentah'; ?>" method="post" class="form-horizontal">
                <div class="box-body">

                <div class="form-group">
                         <label for="inputEmail3" class="col-sm-4 control-label">Tanggal</label>
                         <div class="col-sm-8">
                           <input type="text" class="form-control pull-right" name="tanggal_pengiriman" id="datepicker">
                         </div>
                </div>
                <div class="form-group">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td><?=$u->status;?></td>
                        <td>
                            <a href="<?php echo base_url('modul_produksi/lihat_bahan_mentah/?');?>id=<?php echo $u->id ?>" class="btn btn-primary btn-xs"><i class="fa   fa-edit" ></i>Update</a><br>
                          <a href="<?php echo base_url('modul_produksi/ubah_status_diterima_bahan_mentah/?');?>id=<?php echo $u->id ?>" class="btn btn-danger btn-xs"><i class="fa   fa-close" ></i>Hapus</a>
                        </td>
                    </tr>
                    <?php
                      $no++;
