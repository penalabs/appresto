...
class modul_logistik extends CI_Controller
{
	...
	{
		$id_logistik = $this->session->userdata('id');
		$data['bahanMentah'] = $this->m_modul_logistik->tampilDataBahan($id_logistik)->result();
		$data['bahanOlahan'] = $this->m_modul_logistik->tampilDataOlahan($id_logistik)->result();
		$data['Peralatan'] = $this->m_modul_logistik->tampilDataPeralatan($id_logistik)->result();
		$this->load->view('modul_logistik/stokBahan', $data);
	}
}
