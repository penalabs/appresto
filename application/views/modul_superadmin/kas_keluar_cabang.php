          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form class="form-horizontal" action="<?php echo base_url(). 'superadmin/tambah_data_kas_keluar_cabang'; ?>" method="post" role="form">
                  <div class="box-body">
                        ...
                        <tr >
                              ...
                              <td><?php
                               ...
                               ?></td>
                                ...
                                <button type="submit" class="btn btn-success btn-xs edit" data-toggle="modal" data-target="#myModalEdit" data-toggle="tooltip" title="Detail"> <i class="fa  fa-edit" ></i></button>
                                <a href="<?php echo site_url('superadmin/delete_data_kas_keluar_cabang/'.$data->id_pengeluaran) ?>" class="btn btn-danger btn-xs"><i class="fa  fa-close" ></i></a>
                                <a href="<?php echo site_url('superadmin/delete_data_kas_keluar_cabang/'.$data->id_pengeluaran) ?>" class="btn btn-danger btn-xs"><i class="fa  fa-eye" ></i></a>
                              </td> -->
                        </tr>
                        <?php
                        	}
...
<script type="text/javascript">
  ...
  function ambilDataKasKeluarCabang(){
    $.ajax({
      type:'POST',
        url:'<?php echo base_url()."superadmin/edit_data_kas_keluar_cabang/" ?>'+id_kas_keluar_cabang,
      dataType:'json',
