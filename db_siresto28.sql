...
--
-- Host: 127.0.0.1
-- Generation Time: 26 Jul 2020 pada 17.21
...
-- Fungsi
--
CREATE DEFINER=`root`@`localhost` FUNCTION `saldo_investasi_cabang` (`id_Rest` INT) RETURNS INT(11) BEGIN
...
CREATE DEFINER=`root`@`localhost` FUNCTION `saldo_investasi_induk` (`id_bend` INT) RETURNS INT(11) BEGIN
          DECLARE jumlah INT;
...
--
-- Struktur dari tabel `detail_kas`
--
...
--
-- Dumping data untuk tabel `detail_kas`
--
...
--
-- Struktur dari tabel `investasi_buka_resto`
--
...
--
-- Dumping data untuk tabel `investasi_buka_resto`
--
...
--
-- Dumping data untuk tabel `kas_owner`
--
...
--
-- Dumping data untuk tabel `kas_saldo`
--
...
(8, 30, '1', '', '2020-03-01', 45500, 45500, 'selesai', ''),
(9, 34, '1', 'dasda', '2020-03-11', 45522, 45500, 'selesai', ''),
(10, 34, '2', 'awasdas', '2020-03-31', 5000000, 5000000, 'selesai', NULL),
(13, 34, '11', 'qwa', '2020-04-02', 1200000, 1200000, 'selesai', 'ok'),
(15, 34, '12', '123', '0000-00-00', 10000, 10000, 'selesai', NULL),
(16, 34, '13', 'qas', '2020-04-03', 120000, 120000, 'selesai', NULL),
(17, 34, '14', 'zasx', '2020-04-03', 30000, 30000, 'selesai', 'ok');

--
-- Trigger `pembelian_alat`
--
DELIMITER $$
CREATE TRIGGER `detail_kas_alat` AFTER INSERT ON `pembelian_alat` FOR EACH ROW BEGIN
    INSERT INTO `detail_kas`
    set id_ref_kas = NEW.id,
    jenis_kas="kas induk",
    tipe_kas="Keluar",
...
--
-- Trigger `pembelian_bahan_mentah`
--
DELIMITER $$
...
(11, 32, 4, '2020-04-03', 1000000, 'pengajuan');
...
(1, 'coba1', 1, '', '2020-03-02 21:35:00', 24000, 23, 'lunas'),
(2, 'coba2', 2, '', '2020-03-02 21:35:25', 13000, 23, 'lunas'),
(3, 'coba3', 3, 'ini pembayaran dilakukan di kasir', '2020-03-02 21:49:42', 16000, 23, 'lunas'),
(4, 'coba4', 4, '', '2020-03-02 21:58:05', 13000, 23, 'lunas'),
(5, 'coba5', 5, '', '2020-02-01 22:53:18', 13000, 23, 'lunas'),
(6, 'coba5', 1, '', '2020-02-01 22:53:42', 0, 23, 'siapsaji'),
(7, 'uzin', 6, 'asu', '2020-07-26 21:34:47', 70000, 23, 'produksi_lunas');
...
--
-- Struktur dari tabel `pendapatan_kas_masuk_dari_kasir`
--
...
--
-- Dumping data untuk tabel `pendapatan_kas_masuk_dari_kasir`
--

INSERT INTO `pendapatan_kas_masuk_dari_kasir` (`id`, `id_user_kasir`, `id_adminresto`, `jumlah_setoran`, `tanggal`) VALUES
(34, 22, 19, '53000', '2020-03-08 22:53:26'),
(35, 25, 19, '100000', '2020-04-03 04:03:45'),
(36, 22, 19, '147000', '2020-04-03 04:04:48');

--
-- Trigger `pendapatan_kas_masuk_dari_kasir`
--
DELIMITER $$
...
--
-- Trigger `pengeluaran_cabang_operasional`
--
DELIMITER $$
...
--
-- Trigger `pengeluaran_kanwil_operasional`
--
DELIMITER $$
...
(10, 1, 1, 1, '0000-00-00', '10', '3 bulan', 'proses pengiriman'),
(20, 0, 7, 1, '0000-00-00', '10', '12 bulan', 'permintaan');

--
-- Trigger `permintaan_alat`
--
DELIMITER $$
CREATE TRIGGER `stok_pengurangan` AFTER UPDATE ON `permintaan_alat` FOR EACH ROW BEGIN
...
--
-- Indexes for table `detil_bahan_mentah`
--
...
--
-- Indexes for table `investasi_buka_resto`
--
ALTER TABLE `investasi_buka_resto`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `kas_owner`
--
ALTER TABLE `kas_owner`
  ADD PRIMARY KEY (`id`) USING BTREE;
...
--
-- Indexes for table `pendapatan_kas_masuk_dari_kasir`
--
ALTER TABLE `pendapatan_kas_masuk_dari_kasir`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pengeluaran_cabang`
--
...
--
-- Indexes for table `pengeluaran_kanwil`
--
...
--
-- AUTO_INCREMENT for table `detail_kas`
--
ALTER TABLE `detail_kas`
  MODIFY `id_kas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=132;
--
...
--
-- AUTO_INCREMENT for table `detil_bahan_mentah`
--
ALTER TABLE `detil_bahan_mentah`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
...
--
-- AUTO_INCREMENT for table `gaji_kanwil`
--
ALTER TABLE `gaji_kanwil`
...
--
-- AUTO_INCREMENT for table `investasi_buka_resto`
--
ALTER TABLE `investasi_buka_resto`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
...
--
-- AUTO_INCREMENT for table `kas_owner`
--
ALTER TABLE `kas_owner`
...
ALTER TABLE `pendapatan_kas_masuk`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
--
-- AUTO_INCREMENT for table `pendapatan_kas_masuk_dari_kasir`
--
ALTER TABLE `pendapatan_kas_masuk_dari_kasir`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
--
-- AUTO_INCREMENT for table `pengeluaran_cabang`
--
ALTER TABLE `pengeluaran_cabang`
...
ALTER TABLE `pengeluaran_cabang_operasional`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `pengeluaran_kanwil`
--
ALTER TABLE `pengeluaran_kanwil`
...
--
ALTER TABLE `permintaan_alat`
  MODIFY `id_permintaan_alat` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
--
