...
-- ----------------------------
INSERT INTO `bahan_olahan` VALUES (1, 34, 'ayam kampung paha', 'buah', 11, 1);
INSERT INTO `bahan_olahan` VALUES (3, 34, 'ayam kampung dada', 'buah', 2, 1);
...
-- Records of gaji
-- ----------------------------
INSERT INTO `gaji` VALUES (5, 4, 23, '2020-01-01', '2020-01-31', 'bulanan', 2008000);
...
INSERT INTO `intensif_waiters` VALUES (36, '23', '2020-08-18 19:30:38', '1000');
INSERT INTO `intensif_waiters` VALUES (37, '23', '2020-08-18 19:31:38', '1000');
...
-- Records of menu
-- ----------------------------
INSERT INTO `menu` VALUES (1, 7, 5, 'Ayam Geprek', 'Capture21.PNG', 10000, 'tersedia', -14, 'insert');
INSERT INTO `menu` VALUES (2, 7, 11, 'Jamur Kripsi', 'Capture2ds.PNG', 10000, 'tersedia', 2, 'insert');
INSERT INTO `menu` VALUES (3, 7, 9, 'Es Teh Anget', 'default.jpg', 10000, 'tersedia', 11, 'insert');
INSERT INTO `menu` VALUES (4, 7, 10, 'Kopi Susu', 'kopihitam.jpg', 3000, 'habis', 6, 'insert');
INSERT INTO `menu` VALUES (5, 7, 5, 'Nasi Goreng', 'default.jpg', 3000, 'tersedia', 8, 'insert');
INSERT INTO `menu` VALUES (6, 7, 4, 'Tahu Kripsi', 'default.jpg', 6000, 'tersedia', 2, 'insert');
INSERT INTO `menu` VALUES (7, 7, 9, 'teh pucuk', 'default.jpg', 3000, 'tersedia', 3, 'insert');
INSERT INTO `menu` VALUES (8, 7, 5, 'Nasi Kuning', 'default.jpg', 50000, 'habis', 0, 'insert');
INSERT INTO `menu` VALUES (9, 7, 7, 'Mie Instan', 'default.jpg', 25000, 'tersedia', 1, 'insert');
INSERT INTO `menu` VALUES (10, 7, 7, 'Mie Sedap', 'default.jpg', 25000, 'tersedia', 1, 'insert');
INSERT INTO `menu` VALUES (11, 7, 7, 'Mie Setan', 'default.jpg', 25000, 'tersedia', 5, 'insert');
INSERT INTO `menu` VALUES (12, 7, 5, 'Nasi Putih', 'Capture22.PNG', 5000, 'tersedia', 0, 'insert');
...
-- Records of paket
-- ----------------------------
INSERT INTO `paket` VALUES (1, 7, 9, 'Paket Bom', 5, 'tersedia', 'default.jpg', '8000', 'insert');
INSERT INTO `paket` VALUES (2, 7, 8, 'Paket Granat', 7, 'tersedia', 'default.jpg', '20000', 'insert');
INSERT INTO `paket` VALUES (3, 7, 7, 'Paket asoy', 5, 'habis', 'nasibebek.jpg', '30000', 'insert');
...
-- ----------------------------
INSERT INTO `pembayaran` VALUES (34, 23, 2, 15000, NULL, NULL, 'lunas', '2020-03-08 21:35:25');
INSERT INTO `pembayaran` VALUES (35, 23, 1, 25000, NULL, NULL, 'lunas', '2020-03-08 15:42:30');
INSERT INTO `pembayaran` VALUES (36, 23, 3, 20000, NULL, NULL, 'lunas', '2020-03-08 17:09:06');
INSERT INTO `pembayaran` VALUES (38, 23, 4, 25000, NULL, NULL, 'lunas', '2020-03-06 20:42:38');
INSERT INTO `pembayaran` VALUES (39, 22, 5, 15000, NULL, NULL, 'lunas', '2020-02-01 16:55:53');
INSERT INTO `pembayaran` VALUES (40, 23, 7, 100000, NULL, NULL, 'lunas', '2020-07-26 21:34:47');
INSERT INTO `pembayaran` VALUES (41, 23, 8, 50000, NULL, NULL, 'lunas', '2020-08-18 19:31:38');
...
INSERT INTO `pemberian_kaskeluar` VALUES (11, 32, 4, '2020-04-03', 1000000, 'pemberian');
...
CREATE TABLE `pemesanan`  (
  ...
  `id_user_resto` int(11) NOT NULL,
  `status` enum('belum','kredit','lunas','produksi','siapsaji','selesai','siapsaji_lunas','produksi_lunas','customer memesan') CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `pemesanan` VALUES (7, 'selasa', 2, 'coba', '2020-08-18 19:30:38', 90000, 7, 'lunas');
INSERT INTO `pemesanan` VALUES (8, 'selasa satu', 2, 'coba1', '2020-08-18 19:31:38', 48000, 7, 'lunas');
INSERT INTO `pemesanan` VALUES (16, 'fauzin', 1, 'ok', '2020-10-10 00:00:00', 18000, 7, 'customer memesan');
INSERT INTO `pemesanan` VALUES (17, 'irhas', 2, 'ok', '2020-10-10 00:00:00', 18000, 7, 'customer memesan');
INSERT INTO `pemesanan` VALUES (18, 'debi', 3, 'ok', '2020-10-10 00:00:00', 18000, 7, 'customer memesan');
...
-- ----------------------------
INSERT INTO `pemesanan_menu` VALUES (70, 7, 9, 1, 25000, '');
INSERT INTO `pemesanan_menu` VALUES (71, 7, 10, 1, 25000, '');
INSERT INTO `pemesanan_menu` VALUES (72, 8, 1, 4, 40000, '');
INSERT INTO `pemesanan_menu` VALUES (86, 16, 1, 1, 10000, '');
INSERT INTO `pemesanan_menu` VALUES (87, 17, 1, 1, 10000, '');
INSERT INTO `pemesanan_menu` VALUES (88, 18, 1, 1, 10000, '');
...
-- ----------------------------
INSERT INTO `pemesanan_paket` VALUES (38, 7, 2, 2, 40000, '');
INSERT INTO `pemesanan_paket` VALUES (39, 8, 1, 1, 8000, '');
INSERT INTO `pemesanan_paket` VALUES (40, 9, 1, 1, 8000, '');
INSERT INTO `pemesanan_paket` VALUES (47, 16, 1, 1, 8000, '');
INSERT INTO `pemesanan_paket` VALUES (48, 17, 1, 1, 8000, '');
INSERT INTO `pemesanan_paket` VALUES (49, 18, 1, 1, 8000, '');
...
-- ----------------------------
INSERT INTO `pendapatan_kas_masuk_dari_kasir` VALUES (34, 22, 4, 19, '53000', '2020-03-08 22:53:26');
INSERT INTO `pendapatan_kas_masuk_dari_kasir` VALUES (35, 25, 4, 19, '100000', '2020-04-03 04:03:45');
INSERT INTO `pendapatan_kas_masuk_dari_kasir` VALUES (36, 22, 4, 19, '147000', '2020-04-03 04:04:48');
...
INSERT INTO `pengiriman_bahan_mentah` VALUES (6, 6, 1, '2020-07-27', 1, 1, 0, 'sesuai', 'belum diterima');
...
-- ----------------------------
INSERT INTO `peralatan` VALUES (1, 34, 1, 'sendok', 'pcs', 242, 1);
...
INSERT INTO `produksi_bahan_olahan` VALUES (15, 34, 1, 1, '2020-08-22', 'produksi');
...
INSERT INTO `produksi_bahan_olahan_detail` VALUES (22, 34, 2, 1, 2, '2020-08-22');
INSERT INTO `produksi_bahan_olahan_detail` VALUES (27, 34, 10, 1, 4, '2020-08-22');
INSERT INTO `produksi_bahan_olahan_detail` VALUES (29, 34, 15, 1, 2, '2020-08-22');
INSERT INTO `produksi_bahan_olahan_detail` VALUES (30, 34, 15, 3, 2, '2020-08-22');
...
CREATE TABLE `stok_bahan_mentah_produksi`  (
  ...
  `id_resto` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `fr_idResto`(`id_resto`) USING BTREE,
...
-- ----------------------------
INSERT INTO `stok_bahan_mentah_produksi` VALUES (1, 1, 22, 4);
INSERT INTO `stok_bahan_mentah_produksi` VALUES (2, 2, 51, 4);
INSERT INTO `stok_bahan_mentah_produksi` VALUES (3, 3, 9, 4);
...
CREATE TABLE `stok_bahan_olahan_produksi`  (
  ...
  `id_resto` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `fk_idResto`(`id_resto`) USING BTREE,
...
-- ----------------------------
INSERT INTO `stok_bahan_olahan_produksi` VALUES (1, 1, 1, 4);
INSERT INTO `stok_bahan_olahan_produksi` VALUES (2, 3, 6, 4);
...
-- ----------------------------
-- Table structure for tbl_kategori_menu
-- ----------------------------
...
-- ----------------------------
-- Records of tbl_kategori_menu
-- ----------------------------
INSERT INTO `tbl_kategori_menu` VALUES (1, 'Makanan', 0);
INSERT INTO `tbl_kategori_menu` VALUES (2, 'Minuman', 0);
INSERT INTO `tbl_kategori_menu` VALUES (4, 'Snack', 0);
INSERT INTO `tbl_kategori_menu` VALUES (5, 'Nasi', 1);
INSERT INTO `tbl_kategori_menu` VALUES (7, 'Mie', 1);
INSERT INTO `tbl_kategori_menu` VALUES (8, 'Rujak', 1);
INSERT INTO `tbl_kategori_menu` VALUES (9, 'Panas', 2);
INSERT INTO `tbl_kategori_menu` VALUES (10, 'Dingin', 2);
INSERT INTO `tbl_kategori_menu` VALUES (11, 'Kering', 4);
INSERT INTO `tbl_kategori_menu` VALUES (12, 'Basah', 4);

-- ----------------------------
-- Table structure for tbl_kategori_paket
-- ----------------------------
...
-- ----------------------------
-- Records of tbl_kategori_paket
-- ----------------------------
INSERT INTO `tbl_kategori_paket` VALUES (1, 'Sultan', 0);
INSERT INTO `tbl_kategori_paket` VALUES (2, 'Mahal', 0);
INSERT INTO `tbl_kategori_paket` VALUES (4, 'Murah', 0);
INSERT INTO `tbl_kategori_paket` VALUES (5, 'Gratis', 0);
INSERT INTO `tbl_kategori_paket` VALUES (7, 'Paket Kucing', 4);
INSERT INTO `tbl_kategori_paket` VALUES (8, 'Paket Singa', 2);
INSERT INTO `tbl_kategori_paket` VALUES (9, 'Paket Gajah', 1);
INSERT INTO `tbl_kategori_paket` VALUES (10, 'Paket Cacing', 5);
...
INSERT INTO `tbl_kinerja_karyawan` VALUES (20, 23, 8, 1);
...
-- ----------------------------
-- Triggers structure for table pemesanan_menu
-- ----------------------------
DROP TRIGGER IF EXISTS `stok_menu`;
delimiter ;;
CREATE TRIGGER `stok_menu` AFTER INSERT ON `pemesanan_menu` FOR EACH ROW BEGIN
...
-- Triggers structure for table pemesanan_menu
-- ----------------------------
DROP TRIGGER IF EXISTS `stok_update_menu`;
delimiter ;;
CREATE TRIGGER `stok_update_menu` AFTER UPDATE ON `pemesanan_menu` FOR EACH ROW BEGIN
	UPDATE menu SET stok=stok-NEW.jumlah_pesan
	WHERE id = NEW.id_menu;
    END
;;
...
-- Triggers structure for table pemesanan_menu
-- ----------------------------
DROP TRIGGER IF EXISTS `stok_return_menu`;
delimiter ;;
CREATE TRIGGER `stok_return_menu` BEFORE DELETE ON `pemesanan_menu` FOR EACH ROW BEGIN
...
-- ----------------------------
-- Triggers structure for table pemesanan_paket
-- ----------------------------
DROP TRIGGER IF EXISTS `stok_paket`;
delimiter ;;
CREATE TRIGGER `stok_paket` AFTER INSERT ON `pemesanan_paket` FOR EACH ROW BEGIN
...
-- Triggers structure for table pemesanan_paket
-- ----------------------------
DROP TRIGGER IF EXISTS `stok_update_paket`;
delimiter ;;
CREATE TRIGGER `stok_update_paket` AFTER UPDATE ON `pemesanan_paket` FOR EACH ROW BEGIN
	UPDATE paket SET jumlah=jumlah-NEW.jumlah_pesan
	WHERE id = NEW.id_paket;
    END
;;
...
-- Triggers structure for table pemesanan_paket
-- ----------------------------
DROP TRIGGER IF EXISTS `stok_return_paket`;
delimiter ;;
CREATE TRIGGER `stok_return_paket` BEFORE DELETE ON `pemesanan_paket` FOR EACH ROW BEGIN
