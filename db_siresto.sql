...
insert  into `gaji`(`id`,`id_resto`,`id_user_resto`,`tanggal_awal`,`tanggal_akhir`,`jenis_gaji`,`nominal_gaji`) values (5,4,23,'2020-01-01','2020-01-31','bulanan',2005000),(6,4,20,'2020-03-01','2020-03-31','bulanan',900000),(7,7,24,'2020-03-01','2020-03-31','bulanan',1000000),(9,4,22,'2020-04-03','2020-04-30','bulanan',900000),(10,4,22,'2020-04-03','2020-04-03','bulanan',900000);
...
insert  into `pembayaran`(`id`,`id_user_kasir`,`id_pemesanan`,`nominal`,`status`,`tanggal`) values (34,23,2,15000,'lunas','2020-03-08 21:35:25'),(35,23,1,25000,'lunas','2020-03-08 15:42:30'),(36,23,3,20000,'lunas','2020-03-08 17:09:06'),(38,23,4,25000,'lunas','2020-03-06 20:42:38'),(39,22,5,15000,'lunas','2020-02-01 16:55:53'),(40,23,16,500000,'lunas','2020-04-12 23:01:35');
...
insert  into `pembelian_alat`(`id`,`id_logistik`,`no_transaksi`,`nama_supplier`,`tanggal`,`total_harga_beli`,`dibayar`,`status`,`catatan`) values (5,3,'1','fauzin','2019-10-16',8000,8000,'selesai','ok'),(6,3,'6','','2019-10-16',49000,49000,'selesai','ok'),(7,3,'7','Tmart','2020-01-14',209000,200000,'selesai',''),(8,30,'1','','2020-03-01',45500,45500,'selesai',''),(9,34,'1','dasda','2020-03-11',45522,45500,'selesai',''),(10,34,'2','awasdas','2020-03-31',5000000,5000000,'selesai',NULL),(13,34,'11','qwa','2020-04-02',1200000,1200000,'selesai','ok'),(15,34,'12','123','0000-00-00',10000,10000,'selesai',NULL),(16,34,'13','qas','2020-04-03',120000,120000,'selesai',NULL),(17,34,'14','zasx','2020-04-03',30000,30000,'selesai','ok');
...
insert  into `pemesanan`(`id`,`nama_pemesan`,`no_meja`,`keterangantambahan`,`tanggal`,`total_harga`,`id_user_resto`,`status`) values (1,'coba1',1,'','2020-03-02 21:35:00',24000,23,'lunas'),(2,'coba2',2,'','2020-03-02 21:35:25',13000,23,'lunas'),(3,'coba3',3,'ini pembayaran dilakukan di kasir','2020-03-02 21:49:42',16000,23,'lunas'),(4,'coba4',4,'','2020-03-02 21:58:05',13000,23,'lunas'),(5,'coba5',5,'','2020-02-01 22:53:18',13000,23,'lunas'),(6,'coba5',1,'','2020-02-01 22:53:42',0,23,'siapsaji'),(16,'cobasetorkasir',10,'','2020-04-12 23:03:26',50000,23,'lunas');
...
insert  into `pendapatan_kas_masuk`(`id`,`id_user_bendahara`,`id_user_kasir`,`jumlah_setoran`,`tanggal`,`tanggal_awal`,`tanggal_akhir`) values (34,32,19,'1000000','2020-04-12 00:00:00','0000-00-00 00:00:00','0000-00-00 00:00:00'),(35,32,19,'2500000','2020-04-12 00:00:00','0000-00-00 00:00:00','0000-00-00 00:00:00'),(36,32,19,'2550000','2020-04-12 00:00:00','0000-00-00 00:00:00','0000-00-00 00:00:00');
...
insert  into `pendapatan_kas_masuk_dari_kasir`(`id`,`id_resto`,`id_user_kasir`,`id_adminresto`,`jumlah_setoran`,`tanggal`) values (36,4,22,19,'800000','2020-04-08'),(37,4,22,19,'200000','2020-04-09'),(38,4,22,19,'800000','2020-04-10'),(39,4,22,19,'700000','2020-04-11'),(40,3,22,19,'42000','2020-04-12'),(43,4,22,19,'50000','2020-04-13');
...
insert  into `permintaan_alat`(`id_permintaan_alat`,`id_resto`,`id_kanwil`,`id_alat`,`tanggal`,`jumlah`,`masa_pemanfatan`,`status_permintaan`) values (8,1,1,1,'0000-00-00','1','2 bulan','diterima'),(9,1,1,1,'0000-00-00','50','10 bulan','permintaan'),(10,1,1,1,'0000-00-00','10','3 bulan','proses pengiriman'),(20,0,7,1,'0000-00-00','10','12 bulan','permintaan');
...
/* Trigger structure for table `pembelian_alat` */

DELIMITER $$

/*!50003 DROP TRIGGER*//*!50032 IF EXISTS */ /*!50003 `detail_kas_alat` */$$

/*!50003 CREATE */ /*!50017 DEFINER = 'root'@'localhost' */ /*!50003 TRIGGER `detail_kas_alat` AFTER INSERT ON `pembelian_alat` FOR EACH ROW BEGIN
    INSERT INTO `detail_kas`
    set id_ref_kas = NEW.id,
    jenis_kas="kas induk",
    tipe_kas="Keluar",
...
/* Trigger structure for table `permintaan_alat` */

DELIMITER $$

/*!50003 DROP TRIGGER*//*!50032 IF EXISTS */ /*!50003 `stok_pengurangan` */$$

/*!50003 CREATE */ /*!50017 DEFINER = 'root'@'localhost' */ /*!50003 TRIGGER `stok_pengurangan` AFTER UPDATE ON `permintaan_alat` FOR EACH ROW BEGIN
    IF NEW.status_permintaan="proses pengiriman" then begin
	UPDATE peralatan SET jumlah_stok=jumlah_stok-NEW.jumlah
	WHERE id = NEW.id_alat;
    end; end if;
