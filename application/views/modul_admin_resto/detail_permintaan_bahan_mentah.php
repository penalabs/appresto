    ...
    <section class="content">
      ...
      <div class="col-md-4">
            ...
            <div class="box box-info">
              ...
              <!-- /.box-header -->
              <!-- form start -->
              <form action="<?php echo base_url(). 'C_modul_admin_resto/aksi_tambah_produksi'; ?>" method="post" class="form-horizontal">
                <div class="box-body">
  	...
  	<div class="col-md-8">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td><?=$u->tanggal;?></td>
                        <td><?=$u->status;?></td>
                        <td><a href="<?php echo base_url('C_modul_admin_resto/ubah_status_diterima/?');?>id=<?php echo $u->id ?>" class="btn btn-primary btn-xs"><i class="fa   fa-edit" ></i>Terima Bahan</a></td>
                    </tr>
                    <?php
                      $no++;
                      }
          ...
          <div class="col-md-6">
                ...
                <div class="box box-info">
                  ...
                  <!-- /.box-header -->
                  <!-- form start -->
                  <form action="<?php echo base_url(). 'C_modul_admin_resto/aksi_tambah_bahan_mentah_produksi'; ?>" method="post" class="form-horizontal">
                    <div class="box-body">
          ...
          <div class="col-md-6">
                ...
                <div class="box box-info">
                  ...
                  <!-- /.box-header -->
                  <!-- form start -->
                  <form action="<?php echo base_url(). 'C_modul_admin_resto/aksi_tambah_bahan_olahan_produksi'; ?>" method="post" class="form-horizontal">
                    <div class="box-body">
                    <input type="hidden" name="menu" class="form-control" id="inputEmail3" value="<?=$_GET['menu'];?>" >
                    <input type="hidden" name="id_produksi_masakan" class="form-control" id="inputEmail3" value="<?=$_GET['id'];?>" >
            				<div class="form-group">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><a href="<?php echo base_url('C_modul_admin_resto/hapus_produksi_masakan_bahan_mentah/?');?>id=<?php echo $u->id ?>&&menu=<?=$_GET['menu'];?>&&jumlah=<?=$u->jumlah;?>&&id_produksi_masakan=<?=$id_produksi_masakan;?>&&id_bahan_mentah=<?=$u->id_bahan_mentah;?>" class="btn btn-primary btn-xs"><i class="fa   fa-edit" ></i>Hapus bahan</a></td>
                    </tr>
                    <?php
                    $no++;
                    }
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                          ...
                          <td><a href="<?php echo base_url('C_modul_admin_resto/hapus_produksi_masakan_bahan_olahan/?');?>id=<?php echo $u->id ?>&&menu=<?=$_GET['menu'];?>&&jumlah=<?=$u->jumlah;?>&&id_produksi_masakan=<?=$id_produksi_masakan;?>&&id_bahan_olahan=<?=$u->id_bahan_olahan;?>" class="btn btn-primary btn-xs"><i class="fa   fa-edit" ></i>Hapus bahan</a></td>
                      </tr>
                      <?php
                      $no++;
                      }
