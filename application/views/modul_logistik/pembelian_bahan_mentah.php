          ...
          <div class="box box-solid">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                         ...
                         <div class="col-sm-9">
                           <input type="hidden" value="<?php echo $id_logistik;?>" class="form-control">
                           <input type="text"  value="<?php echo $id_logistik;?>" name="id_logistik" class="form-control" id="id_logistik" disabled>
                         </div>
                </div>
                <div class="form-group">
