  ...
  <div class="row">
    <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <form action="<?php echo base_url(). 'modul_general_manager/bendahara_pengeluaran_investasi_editaksi'; ?>" method="post" class="form-horizontal">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="number" name="persen_susut"  value="<?=$dataedit->persen_penyusutan;?>" class="form-control" >
                  </div>
                </div>
              <!-- /.box-body -->
