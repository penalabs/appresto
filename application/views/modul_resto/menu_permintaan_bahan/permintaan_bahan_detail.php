          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form class="form-horizontal" action="<?php echo base_url(). 'modul_resto/tambah_data_permintaan_bahan_detail'; ?>" method="post" role="form">
                  <div class="box-body">
                ...
                <div class="modal fade" id="myModalAmbilBahanTidakSesuai" role="dialog">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <form class="form-horizontal" action="<?php echo base_url(). 'modul_resto/update_tidak_sesuai_data_permintaan_bahan_detail'; ?>" method="post" role="form">
                          <div class="box-body">
	...
	<div class="col-md-12">
          <div class="box">
            <div class="box-header">
              ...
              <a      <?php echo $button_ajukan_permintaan ?> href="<?php echo site_url('modul_resto/update_proses_permintaan/') ?><?php echo $id_permintaan ?> " class="btn btn-primary btn-md" data-toggle="modal" > <i class="fa fa-chevron-circle-right" aria-hidden="true"> Ajukan permintaan </i></a>
              <a      <?php echo $button_diterima ?> href="<?php echo site_url('modul_resto/update_diterima/') ?><?php echo $id_permintaan ?> " class="btn btn-success btn-md" data-toggle="modal" > diterima </a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr id="<?php echo $data->id_detail_permintaan; ?>">
                      ...
                      <td>
                        ...
                        <a <?php echo $btn_update_sesuai ?>       href="<?php echo site_url('modul_resto/update_sesuai_data_permintaan_bahan_detail/'.$data->id_detail_permintaan) ?>" class="btn btn-success btn-xs"> sesuai </a>
